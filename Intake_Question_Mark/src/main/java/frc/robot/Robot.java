...
public class Robot extends TimedRobot {
   ...
   * initialization code.
   */
  CANSparkFlex topMotor = new CANSparkFlex(62, CANSparkLowLevel.MotorType.kBrushless);

  CANSparkFlex bottomMotor = new CANSparkFlex(58, CANSparkLowLevel.MotorType.kBrushless);
